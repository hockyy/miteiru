...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  reencodeVideoWithAudioTrack: (inputPath: string, audioStreamIndex: number, convertToX264?: boolean, convertAudioToAac?: boolean, totalDuration?: number) =>
    ipcRenderer.invoke('reencode-video-with-audio-track', inputPath, audioStreamIndex, convertToX264, convertAudioToAac, totalDuration),
